...
function bancodados(){
    ...
    db.transaction(function (tx) {   
        tx.executeSql('CREATE TABLE IF NOT EXISTS Clients (id INTEGER PRIMARY KEY AUTOINCREMENT, nome TEXT, rg TEXT, cpf TEXT, cep TEXT, ibge TEXT, rua TEXT, uf TEXT, bairro TEXT, cidade TEXT, telefone TEXT, sexo TEXT, data TEXT, Civil TEXT )'); 
     ...
     db.transaction(function (tx) {   
        tx.executeSql('INSERT INTO Client (nome,rg,cpf,cep,rua,uf,bairro,cidade,sexo,data,civil) VALUES (?,?,?,?,?,?,?,?,?,?,?)', [nome,rg,cpf,cep,rua,uf,bairro,cidade,sexo,data,civil]); 
     }); // executando a tabela
